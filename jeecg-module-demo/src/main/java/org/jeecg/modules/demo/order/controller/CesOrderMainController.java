...
import org.jeecg.modules.demo.order.vo.CesOrderMainPage;
...
import org.jeecg.modules.demo.order.service.ICesOrderCustomerService;
...
public class CesOrderMainController {
    ...
    //@RequiresPermissions("order:ces_order_main:add")
    ...
    //@RequiresPermissions("order:ces_order_main:edit")
    ...
    //@RequiresPermissions("order:ces_order_main:delete")
    ...
    //@RequiresPermissions("order:ces_order_main:deleteBatch")
    ...
    * @param cesOrderMain
    */
    //@RequiresPermissions("order:ces_order_main:exportXls")
    ...
    * @return
    */
    //@RequiresPermissions("order:ces_order_main:importExcel")
